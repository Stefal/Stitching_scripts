...
"${pto_var}" --opt=Er1,Eb1,Er2,Eb2,Er3,Eb3,Er4,Eb4,Er5,Eb5,r0,p0,v0,v,a,b,c --modify-opt --unlink=v0,Ra0,Rb0,Rc0,Rd0,Re0,a0,b0,c0,d0,g0,t0,Va0,Vb0,Vc0,Vd0,Vx0,Vy0 -o autobase3.pto autobase2.pto
...
"${hugin_executor}" default4.pto --stitching
