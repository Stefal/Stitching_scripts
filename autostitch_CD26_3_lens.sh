...
"${pto_gen}" --projection=0 --fov=77 --stacklength=1 --output=autobase.pto APN0.jpg APN1.jpg APN2.jpg APN3.jpg APN4.jpg APN5.jpg
"${pto_var}" --set=p0=0,y0=0,p1=0,y1=60,p2=0,y2=120,p3=0,y3=180,p4=0,y4=240,p5=0,y5=300,b=0.05 --modify-opt -o autobase2.pto autobase.pto
"${pto_lensstack}" --new-lens i0,i3 -o autobase3.pto autobase2.pto
"${pto_var}" --opt=y,!y0,r,b,!r0,p,!p0,v,!Ra,!Rb,!Rc,!Rd,!Rd,!Re,Eev,Er,Eb,Vc,Vd,!Er0,!Eb0 --modify-opt -o autobase4.pto autobase3.pto
exit
...
"${cpfind}" --fullscale --prealigned --celeste --sieve1width=20 --sieve1height=20 --sieve1size=200 --kdtreesteps=300 --minmatches=3 -o default1.pto autobase5.pto
