...
"${pto_var}" --opt=r0,p0,v0,v --modify-opt -o autobase4.pto autobase3.pto
...
"${autooptimiser}" -m -o default4.pto default3.pto
"${autooptimiser}" -l -n -o default5.pto default4.pto
